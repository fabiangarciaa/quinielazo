...
let PhasesController = class PhasesController {
    ...
    activate(id) { return this.svc.setActive(id); }
    delete(id) { return this.svc.delete(id); }
    getTeams(id) { return this.svc.getTeamsInPhase(id); }
    closePhase(id, body) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], PhasesController.prototype, "activate", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], PhasesController.prototype, "delete", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], PhasesController.prototype, "getTeams", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", void 0)
], PhasesController.prototype, "closePhase", null);
