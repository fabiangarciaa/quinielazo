...
export declare class TournamentsController {
    ...
    create(body: any): import(".prisma/client").Prisma.Prisma__TournamentClient<{
        id: string;
        name: string;
        createdAt: Date;
        updatedAt: Date;
    ...
    update(id: string, body: any): import(".prisma/client").Prisma.Prisma__TournamentClient<{
        id: string;
        name: string;
        createdAt: Date;
        updatedAt: Date;
    ...
    getScoringRules(id: string): import(".prisma/client").Prisma.PrismaPromise<{
        id: string;
        eventType: import(".prisma/client").$Enums.ScoringEventType;
        points: number;
        isActive: boolean;
    ...
    updateRule(ruleId: string, body: {
        points: number;
        isActive: boolean;
    }): import(".prisma/client").Prisma.Prisma__ScoringRuleClient<{
        id: string;
        eventType: import(".prisma/client").$Enums.ScoringEventType;
        points: number;
        isActive: boolean;
