...
exports.RankingModule = RankingModule = __decorate([
    (0, common_1.Module)({ providers: [ranking_service_1.RankingService], controllers: [ranking_controller_1.RankingController], exports: [ranking_service_1.RankingService] })
], RankingModule);
