...
export declare class ParticipantsController {
    ...
    scores(id: string): import(".prisma/client").Prisma.PrismaPromise<({
        result: {
            match: {
                phase: {
                    id: string;
    ...
    update(id: string, body: any): import(".prisma/client").Prisma.Prisma__ParticipantClient<{
        id: string;
        name: string;
        avatarUrl: string | null;
        tournamentId: string;
    ...
    generateCredentials(tid: string): Promise<any[]>;
}
