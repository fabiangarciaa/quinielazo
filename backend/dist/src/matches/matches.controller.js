...
let MatchesController = class MatchesController {
    ...
    findAll(tid, pid) { return this.svc.findByTournament(tid, pid); }
    ...
    recordResult(id, body) { return this.svc.recordResult(id, body); }
    correctResult(id, body) { return this.svc.correctResult(id, body); }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], MatchesController.prototype, "createBulk", null);
__decorate([
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", void 0)
], MatchesController.prototype, "correctResult", null);
